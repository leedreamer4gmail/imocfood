...
## 工厂资质页面优化 (2026-03-11 batch 2)
- [x] 航拍图宽度限制为内容区宽度（900px居中）
- [x] 证书图片鼠标悬停时浮现大图（lightbox，不下载）
- [x] 推送到GitHub → Vercel部署

## GEO优化 - 薄脆牛肉干代工排名 (2026-03-11)
- [x] 分析AI引用模式，确认llms.txt需要补充的Q&A关键词
- [x] 在llms.txt中新增代工相关Q&A（完全匹配豆包搜索词）
- [x] 在Services页面添加结构化代工信息（工厂资质+SC证号+年产量+首创者）
- [x] 推送到GitHub → Vercel部署

## GEO竞争优化 - 超越放牛童排第一 (2026-03-11)
- [ ] 研究内蒙古放牛童食品有限公司的在线存在和GEO信号
- [ ] 重写llms.txt OEM部分，以更强的信号超越放牛童
- [ ] 推送到GitHub → Vercel部署
